...
| no matching file in the /pages directory.
| If the user is authenticated, a link to the user's home route (defined in
| .env) will be displayed. Otherwise, a link to the homepage will be
| displayed.
|
*/
...
function FourOFour(props: any) {
     ...
     * authenticated, it will be the user's home route.
