...
export class AuthGuard {
    ...
    /**
     * Get the current user from the database and
     ...
     *  The destination URL the user will
     *  be redirected to if they are authenticated.
     *
     * @return {object}
     * An empty object. It is still necessary to
     * return obj as getServerSideProps() requires it.
     */
    public async redirectOnAuthentication(
        ...
        try {
            ...
            /**
             * As the API call is executed on the server
             * it doesn't have the cookies set in the browser.
             * Fortunately, we can extract these cookies from
             * the req object and attach them to the API call.
             */
    ...
    public async authenticateUser(
        ...
        try {
            ...
            //     /**
            //      * No further redirect if we are already on the login path,
            //      * as we otherwise would be caught in an infinite
            //      * loop of redirections to /user/login.
            //      */
            ...
            /**
             * If user is authenticated, and he requests login or register,
            ...
            /**
             * Redirect to login if user is not authenticated and tries to access
             * a protected route
             */
