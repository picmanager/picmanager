...
|-------------------------------------------------------------------------------
|
| Here all the api calls and business logic concerned with authentication are
 ...
 *
 * If the request is successful, the user will get a link by email where
 * they can create a new password.
 *
 * @param {string} email
 ...
 *  The new password.
 * @param {string} token
 *  The token. It must have been created beforehand by declaring
 *  a forgotten password (see forgotPassword()).
 *
 * @return {object}
 */
export const resetPassword = (email: any, password: any, token: any): object => {
    return async (dispatch: CallableFunction) => {
        try {
 ...
 *
 * @return {object}
 *  Includes success and error keys.
 *  Their values will be set depending on verification outcome.
 */
export const verifyEmail = (userID: any, hash: any, expires: any, signature: any): object => {
    return async (dispatch: CallableFunction) => {
        try {
            /**
